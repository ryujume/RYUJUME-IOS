...
protocol MyRyujumeProvider {
    ...
    func putUpdateRyujume(_ ryujume: [String : Any])
    func getMyRyujume()
}
...
protocol DetailRyujumeProvider {
    func getLatestDetailRyujume(_ ryujumeId: String)
    func getLikeDetailRyujume(_ ryujumeId: String)
    func getLikedDetailRyujume(_ ryujumeId: String)
}
