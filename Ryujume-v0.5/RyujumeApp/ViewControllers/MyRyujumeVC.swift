...
class MyRyujumeVC: UIViewController, MyRyujumeProvider {
    ...
    func putUpdateRyujume(_ ryujume: WriteRyujumeModel) {
    ...
    func putMyRyujumeIntoModel() -> WriteRyujumeModel {
        return WriteRyujumeModel(phoneNumber: phoneNumberTxtField.text!,
